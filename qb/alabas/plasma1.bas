'
' Description : Mode 13 VGA Sinusoidal Plasma!
' Written by  : Andrew L. Ayers
' Date        : 07/24/96
'
' Now here's one for the masses! This creates sinusoidal plasma, which
' tends to be way easier to create than cloud plasma. This routine isn't
' optimized too much (a SIN table would speed it up some). Play with it
' some. As always, if you use the routine in your own program or demo,
' please mention my name. Thanks, and have phun!
...
'
LOCATE 2, 9: PRINT "Sinusoidal Plasma Effect!"
