  ...
  FOR OB = 0 TO 0 ' UP TO 9 OBJECTS
    ...
    FOR PL = 0 TO 5 ' CONSISTING OF UP TO 9 PLANES
      ...
      IF VISIBLE > 0 THEN
        ...
        ' REMOVE LINES
        '
        LINE (DPLANE2D(0, 0), DPLANE2D(0, 1))-(DPLANE2D(1, 0), DPLANE2D(1, 1)), PLANECOL(PL)
        LINE -(DPLANE2D(2, 0), DPLANE2D(2, 1)), PLANECOL(PL)
        LINE -(DPLANE2D(3, 0), DPLANE2D(3, 1)), PLANECOL(PL)
        LINE -(DPLANE2D(0, 0), DPLANE2D(0, 1)), PLANECOL(PL)
        '
      END IF
      '
    NEXT PL
