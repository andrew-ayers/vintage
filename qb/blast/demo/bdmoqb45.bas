'****************************************************************************
'
' Description : Blast! Library Demo Program - For QuickBASIC 4.5 Only!
...
'               added to the BCREQB45.BAS program to create the demo.
'
'****************************************************************************
'
...
REDIM sbuffer%(0) ' This is our sprite buffer
'
'****************************************************************************
