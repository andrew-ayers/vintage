...
'*                                                         *
'*            Tutorial Lesson #2 - More Basic 3D           *
'*                                                         *
'*  Loading an object from a file, hidden surface removal  *
'*                                                         *
'*                     March 11, 1999                      *
'*                                                         *
'*                   Updated July 7, 1999                  *
...
Private Sub Form_Click()
  '
  style = style + 1: If style > 2 Then style = 0
  '
End Sub
Private Sub Form_Load()
  ...
  '
  Call LoadMPLGObject(App.Path + "\tutor2.mpl", cube)   ' Load our object
  '
...
Private Sub Timer1_Timer()
  ...
  Do
    ...
    '
    ya = ya + 0.005: If ya > 6.282 Then ya = 0
    pa = pa + 0.007: If pa > 6.282 Then pa = 0
    ra = ra + 0.009: If ra > 6.282 Then ra = 0
    '
...
Private Sub Timer2_Timer()
  ...
  '
  Me.Caption = "VB/3D - Tutorial #2 - FPS = " + Str$(FPS)
  '
