...
Private Sub LoadTextures_Click()
  ...
  Do
    ...
    If CommonDialog1.FileName <> "" Then
      ...
      '
      If bmp2.bmWidth <> TPAGE_XSIZE Or bmp2.bmHeight <> TPAGE_YSIZE Or bmp2.bmPlanes <> 1 Or bmp2.bmBitsPixel <> 8 Then
        Beep
        MsgBox "Invalid bitmap!", vbCritical, "Error!"
      Else
        Exit Do
      End If
    End If
...
Private Sub FPSTimer_Timer()
  ...
  '
  RayCastForm.Caption = "The Prometheus Engine by Andrew L. Ayers -" + Str$(FPS) + " FPS"
  '
  FPS = 0
  '
End Sub
...
Private Sub ViewportImage_Click()
  '
  msg$ = ""
  msg$ = msg$ + "The Prometheus Engine Version 1.6" + Chr$(10)
  msg$ = msg$ + "Copyright (C) 1998-2000 By Andrew L. Ayers" + Chr$(10)
  msg$ = msg$ + Chr$(10)
  ...
  msg$ = msg$ + Chr$(10)
  msg$ = msg$ + "You should have received a copy of the GNU General Public" + Chr$(10)
  msg$ = msg$ + "License along with this program; if not, write to the Free" + Chr$(10)
  msg$ = msg$ + "Software Foundation, Inc., 59 Temple Place - Suite 330," + Chr$(10)
  msg$ = msg$ + "Boston, MA  02111-1307, USA." + Chr$(10)
  msg$ = msg$ + Chr$(10)
  msg$ = msg$ + "Email: andrewa@indirect.com" + Chr$(10)
  msg$ = msg$ + "Web: http://www.goodnet.com/~andrewa" + Chr$(10)
  msg$ = msg$ + Chr$(10)
  msg$ = msg$ + "Much gratitude and thanks go to David Brebner, for without his" + Chr$(10)
  msg$ = msg$ + "inspiration and help, this engine would not exist..." + Chr$(10)
  '
