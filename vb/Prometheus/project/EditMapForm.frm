...
'***********************************************************
'
' This is a very rudimentary form of a map editor - it should work alright,
' but a lot of improvement could be done. It would be nice to see an editor
' that allowed the user to lay out the map with mini scaled down versions of
' the textures, picked from a texture palette. This was just done to make it
' easier to play with (the save map function isn't done yet)...
'
